...
while cap.isOpened():
    ...
    for face_landmarks in results.multi_face_landmarks:
        ...
        if  ((lx_score >0.4 and lx_score <=0.52) or (lx_score >0.55 and lx_score < 0.65))  and ((rx_score > 0.39 and rx_score < 0.5) or (rx_score >= 0.50 and rx_score < 0.65)):
            gaze_direction = "Forward"
        elif lx_score > 0.7 and rx_score > 0.7:
            gaze_direction = "Right"
        elif lx_score>0.29 and lx_score < 0.4 and rx_score>0.43 and rx_score < 0.5:
            gaze_direction = "Left"
        else:
            if (lx_score>0.521 and lx_score < 0.55) and (rx_score>0.65 and rx_score < 0.7):
                gaze_direction = "Down"
# 0.7246713486300547 0.598107480441976
# 0.7234467854261384 0.599053740220988
# 0.7228345038241804 0.599526870110494
# 0.7225283630232013 0.587263435055247



# 0.4128415493227586 0.46823406560809633
# 0.4064207746613793 0.47221227089928625
# 0.395518079638382 0.4503918497353574
# 0.4157077577679089 0.452468652140406

# 0.4915806601278281 0.5321949237603718
# 0.49579033006391404 0.521911415368558
# 0.48473727029511493 0.5347652314938028
# 0.49236863514755747 0.5348244762120177
# 0.4897740611635223 0.5348540985711251


# 0.49331010968276584 0.5064481892693884
# 0.48989829808462615 0.5145877309983306
# 0.4949491490423131 0.5131078189875373
# 0.4974745745211565 0.5123678629821408
        text=""
